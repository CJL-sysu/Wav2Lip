...
class Wav2Lip(nn.Module):
    def __init__(self):
        ...
        self.face_encoder_blocks = nn.ModuleList([
            ...
            nn.Sequential(Conv2d(32, 64, kernel_size=3, stride=1, padding=1),    # 48, 48
            ...
            nn.Sequential(Conv2d(256, 512, kernel_size=3, stride=1, padding=1),     # 12, 12
            Conv2d(512, 512, kernel_size=3, stride=1, padding=1, residual=True),), 
            
            nn.Sequential(Conv2d(512, 512, kernel_size=3, stride=3, padding=0),     # 4, 4
        ...
        self.face_decoder_blocks = nn.ModuleList([
            ...
            nn.Sequential(Conv2dTranspose(1024, 512, kernel_size=3, stride=3, padding=0),
            Conv2d(512, 512, kernel_size=3, stride=1, padding=1, residual=True),# 12, 12
            ), 

            nn.Sequential(Conv2dTranspose(1024, 512, kernel_size=3, stride=1, padding=1),
            Conv2d(512, 512, kernel_size=3, stride=1, padding=1, residual=True),
            Conv2d(512, 512, kernel_size=3, stride=1, padding=1, residual=True),), # 12, 12
# 4
...
# 6
            nn.Sequential(Conv2dTranspose(320, 128, kernel_size=3, stride=1, padding=1),
            Conv2d(128, 128, kernel_size=3, stride=1, padding=1, residual=True),
